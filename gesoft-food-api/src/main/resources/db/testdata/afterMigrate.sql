...
insert into `bd_gesoft-food-api`.`usuario` ( `nome`, `email`,`senha`) values ( 'evaldo', 'evaldo@teste.com', '$2a$12$3jXsY9sVPBBZoAqCi7Z4yunGxHdiHDQvdi2w332pixetnb5TlquZG');
insert into `bd_gesoft-food-api`.`usuario` (`nome`, `email`,`senha`) values ('tuca', 'tuca@teste.com', '$2a$12$3jXsY9sVPBBZoAqCi7Z4yunGxHdiHDQvdi2w332pixetnb5TlquZG');
insert into `bd_gesoft-food-api`.`usuario` ( `nome`, `email`,`senha`) values ( 'evaldo2', 'evaldo2@teste.com', '$2a$12$3jXsY9sVPBBZoAqCi7Z4yunGxHdiHDQvdi2w332pixetnb5TlquZG');
insert into `bd_gesoft-food-api`.`usuario` (`nome`, `email`,`senha`) values ('tuca2', 'tuca2@teste.com', '$2a$12$3jXsY9sVPBBZoAqCi7Z4yunGxHdiHDQvdi2w332pixetnb5TlquZG');
